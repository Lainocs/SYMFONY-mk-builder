 ...
 */
final class Version20220220184007 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE build CHANGE name name VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
